      ...
      {hasLocation && !isLoading && !error && venues.length > 0 && (
        <div className="overflow-hidden max-w-[1400px] mx-auto mt-6">
          ...
          <div className="flex items-center justify-center gap-4 mt-4 max-w-[350px] mx-auto relative z-40">
            <div ref={prevBtnRef} className="border border-white p-0.5 px-2 rounded-full h-13 w-18 cursor-pointer">
            ...
            <div ref={nextBtnRef} className="bg-gradient-to-r border border-white p-0.5 px-2 rounded-full !h-13 !w-18 cursor-pointer">
              <button className="bg-black rounded-full w-full h-full flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
